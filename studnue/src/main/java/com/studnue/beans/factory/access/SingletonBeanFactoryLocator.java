...
package com.studnue.beans.factory.access;
...
import com.studnue.beans.FatalBeanException;
...
import com.studnue.core.io.UrlResource;
 ...
 *         class="com.studnue.context.support.ClassPathXmlApplicationContext">
 *     &lt;constructor-arg>
 *       &lt;list>
 ...
 * @see com.studnue.context.access.DefaultLocatorFactory
 */
public class SingletonBeanFactoryLocator implements BeanFactoryLocator {
	...
	// see superclass JavaDoc: com.studnue.beans.factory.access.BeanFactoryLocator#useFactory(java.lang.String)
