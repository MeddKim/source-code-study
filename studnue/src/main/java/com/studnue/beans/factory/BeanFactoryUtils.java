...
public abstract class BeanFactoryUtils {
	 ...
	 * @throws com.studnue.beans.BeansException if the beans could not be created
	 */
	 ...
	 * @param includeFactoryBeans whether to include FactoryBeans too or just normal beans
	 * @return the Map of bean instances, or an empty Map if none
	 * @throws com.studnue.beans.factory.NoSuchBeanDefinitionException if 0 or more than 1 beans of the given type were found
	 * @throws com.studnue.beans.BeansException if the bean could not be created
	 */
