...
package com.studnue.aop.target;
...
import com.studnue.aop.support.DefaultIntroductionAdvisor;
import com.studnue.aop.support.DelegatingIntroductionInterceptor;
...
public final class ThreadLocalTargetSource extends AbstractPrototypeTargetSource implements ThreadLocalTargetSourceStats, DisposableBean {
	...
	/**
	 * @see com.studnue.aop.TargetSource#releaseTarget(Object)
	 */
	 ...
	 * clear ThreadLocal.
	 * @see com.studnue.beans.factory.DisposableBean#destroy()
	 */
	public void destroy() {
